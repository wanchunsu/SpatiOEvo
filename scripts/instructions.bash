...
# Step 1: Compute pairwise distances between residues based on the highest resolution PDB structure that these residues map to
python3 get_distances_between_residues.py

# Step 2: Construct interface-specific subgraphs, label nodes and edges
python3 construct_sub_int_cg.py 

# Step 3: Construct whole interface contact graph, label nodes and edges
