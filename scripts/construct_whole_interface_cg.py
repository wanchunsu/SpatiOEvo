...
### label nodes and edges of whole interface contact graph
...
def main():
	...
	annos_data_dir = osp.join(script_dir, '..', 'data', 'contact_graphs')
	dist_data_dir = osp.join(script_dir	, '..', 'data', 'dnds', 'distances_btwn_residues_in_diff_dnds_categories')
